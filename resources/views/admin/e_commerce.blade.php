                ...
                <div class="x_content">
                  <div class="col-md-7 col-sm-7 col-xs-12">
                    <div class="product-image">
                      <img src="{{url('/')}}/backend/images/prod1.jpg" alt="..." />
                    </div>
                    <div class="product_gallery">
                      <a>
                        <img src="{{url('/')}}/backend/images/prod2.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="{{url('/')}}/backend/images/prod3.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="{{url('/')}}/backend/images/prod4.jpg" alt="..." />
                      </a>
                      <a>
                        <img src="{{url('/')}}/backend/images/prod5.jpg" alt="..." />
                      </a>
                    </div>
                  </div>
