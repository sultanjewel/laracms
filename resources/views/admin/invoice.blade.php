                  ...
                  <section class="content invoice">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-6">
                        ...
                        <img src="{{url('/')}}/backend/images/visa.png" alt="Visa">
                        <img src="{{url('/')}}/backend/images/mastercard.png" alt="Mastercard">
                        <img src="{{url('/')}}/backend/images/american-express.png" alt="American Express">
                        <img src="{{url('/')}}/backend/images/paypal2.png" alt="Paypal">
