...
<!-- moris js -->
  <script src="{{url('/')}}/backend/js/moris/raphael-min.js"></script>
  <script src="{{url('/')}}/backend/js/moris/morris.min.js"></script>
  <script src="{{url('/')}}/backend/js/moris/example.js"></script>
