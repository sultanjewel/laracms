...
<script type="text/javascript">
  ...
  <!-- tags -->
  <script src="{{url('/')}}/backend/js/tags/jquery.tagsinput.min.js"></script>
  <!-- switchery -->
  <script src="{{url('/')}}/backend/js/switchery/switchery.min.js"></script>
  <!-- daterangepicker -->
  <script type="text/javascript" src="{{url('/')}}/backend/js/moment/moment.min.js"></script>
  <script type="text/javascript" src="{{url('/')}}/backend/js/datepicker/daterangepicker.js"></script>
  <!-- richtext editor -->
  <script src="{{url('/')}}/backend/js/editor/bootstrap-wysiwyg.js"></script>
  <script src="{{url('/')}}/backend/js/editor/external/jquery.hotkeys.js"></script>
  <script src="{{url('/')}}/backend/js/editor/external/google-code-prettify/prettify.js"></script>
  <!-- select2 -->
  <script src="{{url('/')}}/backend/js/select/select2.full.js"></script>
  <!-- form validation -->
  <script type="text/javascript" src="{{url('/')}}/backend/js/parsley/parsley.min.js"></script>
  <!-- textarea resize -->
  <script src="{{url('/')}}/backend/js/textarea/autosize.min.js"></script>
  <script>
    autosize($('.resizable_textarea'));
  </script>
  <!-- Autocomplete -->
  <script type="text/javascript" src="{{url('/')}}/backend/js/autocomplete/countries.js"></script>
  <script src="{{url('/')}}/backend/js/autocomplete/jquery.autocomplete.js"></script>
  <script type="text/javascript">
    $(function() {
      'use strict';
