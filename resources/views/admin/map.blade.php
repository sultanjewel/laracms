  ...
  <div class="container body">
    <div class="main_container">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-bug"></i> Additional Pages <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="{{url('/')}}/admin/e_commerce_backend">E-commerce Backend</a>
                    </li>
                    ...
                    <li><a href="{{url('/')}}/admin/real_estate">Real Estate</a>
                    </li>
                  </ul>
                </li>
                <li><a><i class="fa fa-windows"></i> Extras <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <li><a href="{{url('/')}}/admin/coming_soon">Coming Soon</a>
                    </li>
                    <li><a href="{{url('/')}}/admin/plain_page">Plain Page</a>
                    </li>
                    <li><a href="{{url('/')}}/admin/login">Login Page</a>
                    </li>
                    <li><a href="{{url('/')}}/admin/sign_up">SignUp Page</a>
                    </li>
                ...
                <ul class="nav navbar-nav navbar-right">
                  <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <img src="{{url('/')}}/backend/images/img.jpg" alt="">John Doe
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right">
                      ...
                      <li><a href="{{url('/')}}/admin/login"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
                      </li>
                    </ul>
                  </li>
                  <li role="presentation" class="dropdown">
      ...
      <head>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="http://vodacom.registersim.com/assets/dashboard/backend/js/daterangepicker-bs3.css" />
        <link rel="stylesheet" href="http://vodacom.registersim.com/assets/dashboard/backend/js/colorbox.css" />
        <link href="http://vodacom.registersim.com/assets/dashboard/backend/css/font/backend/css/font-awesome.min.css" rel="stylesheet">
      ...
      <body data-twttr-rendered="true">
        ...
        <head>
          ...
          <link rel="stylesheet" type="text/css" media="all" href="http://tigo.registersim.com/assets/dashboard/backend/js/daterangepicker-bs3.css" />
          <link rel="stylesheet" href="http://tigo.registersim.com/assets/dashboard/backend/js/colorbox.css" />
          <link href="http://tigo.registersim.com/assets/dashboard/backend/css/font/backend/css/font-awesome.min.css" rel="stylesheet">
        ...
        <body data-twttr-rendered="true">
          ...
          <script type="text/javascript">
            var script = '<script type="text/javascript" src="http://tigo.registersim.com/assets/backend/js/src/markerclusterer';
          ...
          <script src="http://vodacom.registersim.com/assets/dashboard/backend/js/jquery.masonry.min.js"></script>
          <script>
            $(function() {
          ...
          <script src="http://vodacom.registersim.com/assets/dashboard/backend/js/jquery.colorbox.js"></script>
          <script>
          ...
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/backend/js/moment.min.js"></script>
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/backend/js/daterangepicker.js"></script>
          <script type="text/javascript">
            $(document).ready(function() {
          ...
          <script type="text/javascript" src="http://vodacom.registersim.com/assets/dashboard/backend/js/highcharts.js"></script>
